	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				...
				'conditions_title' => /* translators: %s is replaced with "string" */ __( 'Where Do You Want to Display Your %s?', 'lastudio-kit' ),
				'conditions_description' => /* translators: %s is replaced with "string" */ __( 'Set the conditions that determine where your %s is used throughout your site.', 'lastudio-kit' ) . '<br>' . __( 'For example, choose \'Entire Site\' to display the template across your site.', 'lastudio-kit' ),
	...
	public function print_post_type_field() {
		...
		<div id="elementor-new-template__form__post-type__wrapper" class="elementor-form-field">
			<label for="elementor-new-template__form__post-type" class="elementor-form-field__label">
				<?php esc_html_e( 'Select Post Type', 'lastudio-kit' ); ?>
			</label>
			<div class="elementor-form-field__select__wrapper">
				<select id="elementor-new-template__form__post-type" class="elementor-form-field__select" name="<?php echo esc_attr(Single::REMOTE_CATEGORY_META_KEY); ?>">
					...
					foreach ( $post_types as $post_type => $label ) {
						...
						if ( $is_base_page ) {
							...
							echo sprintf( '<option value="%1$s">%2$s</option>', esc_attr($post_type), esc_html($post_type_object->labels->singular_name) );
						}
					}

					// 404.
					echo sprintf( '<option value="%1$s">%2$s</option>', 'not_found404', esc_html__( '404 Page', 'lastudio-kit' ) );
