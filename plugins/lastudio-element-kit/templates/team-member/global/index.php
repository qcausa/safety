...
<div <?php $this->print_render_attribute_string( 'main-container' ); ?>><?php
    ...
    <?php
        ...
        if( $this->get_settings_for_display('paginate') == 'yes' ){
            ...
            ?>
            <nav class="<?php echo esc_attr(join(' ', $nav_classes)) ?>" data-parent-container="#tm_<?php echo esc_attr($this->get_id()) ?>" data-container="#tm_<?php echo esc_attr($this->get_id()) ?> .lastudio-member__list" data-item-selector=".loop__item" data-ajax_request_id="<?php echo esc_attr($paged_key) ?>">
                ...
                $this->print_var(paginate_links( apply_filters( 'lastudio_elementor_ajax_pagination_args', array(
                    'base'         => $p_base,
                    'format'       => $p_format,
                    'add_args'     => false,
