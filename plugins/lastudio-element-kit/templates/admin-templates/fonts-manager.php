<div class="lastudio-kit-settings-page lastudio-kit-settings-page__fonts-manager">
    <div class="cx-vui-title cx-vui-title--divider" v-html="'<?php esc_attr_e('Custom Fonts', 'lastudio-kit'); ?>'"></div>
    ...
    >
        ...
        <span slot="label"><?php esc_html_e('Save Changes', 'lastudio-kit'); ?></span>
    </cx-vui-button>
</div>