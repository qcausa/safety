...
@fs_ignore /lib/, /vendor/, /public/, /external/, /classes/Tools/Video/Player/Tool/
@fs_premium_only /classes/Tools/Assets, /classes/Tools/Optimizer, /classes/Tools/Browser, /classes/Tools/Video/Driver/Mux/Tasks/RegenerateFilmstripTask.php, /classes/Tools/Video/Driver/Mux/Tasks/RelinkTask.php, /classes/Tools/Video/Driver/Mux/Tasks/TransferTask.php, /classes/Tools/Storage/Tasks/MigrateTask.php, /classes/Tools/Storage/Tasks/UpdateGutenbergTask.php, /classes/Tools/Storage/Tasks/RegenerateThumbnailTask.php, /classes/Tools/Integrations, /classes/Tools/ImageSizes/CLI, /classes/Tools/ImageSizes/Tasks, /classes/Tools/ImageSizes/ImageSizeTool.php, /classes/Tools/MediaUpload, /classes/Tools/Network, /classes/Tools/Video/Driver/Mux/MuxToolProSettings.php, /classes/Tools/Video/Player/VideoPlayerToolProSettings.php, /classes/Tools/Video/Driver/Mux/Tasks/MigrateToMuxTask.php, /classes/Tools/Vision/Driver/GoogleCloudVision, /config/optimizer, /config/assets.config.php, /config/integrations.config.php, /config/browser.config.php, /config/optimizer.config.php, /config/glide.config.php, /config/image-sizes.config.php, /config/media-upload.config.php, /config/video-encoding.pro.config.php, /config/video-player.pro.config.php, /config/network.config.php, /config/vision/google.config.php, /views/upload, /views/storage/browser.blade.php, /views/storage/browser-header.blade.php, /views/storage/browser-table.blade.php, /views/integrations, /views/image-sizes
*/
