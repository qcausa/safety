		...
		"groups" => [
			"media-cloud-mux-player" => [
				...
				"options" => [
					...
					"media-cloud-replace-admin-player" => [
						"title" => "Replace WordPress Admin Video Player",
						"description" => "Replace the video player WordPress admin uses with a native player using HLS.js.  This allows you to preview the encoded video without having to create a post.",
						"type" => "checkbox",
						"default" => true,
					],
					"media-cloud-override-player-shortcode" => [
						"title" => "Override WordPress Video Shortcode",
						"description" => "When enabled, any videos embedded in posts with WordPress's <code>[video]</code> shortcode will be replaced with Media Cloud's selected video player.",
						"type" => "checkbox",
						"default" => true,
					],
					...
					"media-cloud-mux-player-customize-colors" => [
						"title" => "Customize Player Colors",
						"description" => "Set the colors for the video.js player.",
						"type" => "checkbox",
						"default" => false,
						"conditions" => [
							"media-cloud-mux-player" => ["videojs"]
					...
					"media-cloud-player-color-primary" => [
						"title" => "Player Primary Color",
						"default" => "#000000",
						"description" => "The primary color of the player, aka the background color.",
						"type" => "color"
					],
					"media-cloud-player-color-buttons" => [
						"title" => "Player Button Color",
						"default" => "#FFFFFF",
						"description" => "The color of the player's buttons.",
						"type" => "color",
					],
					"media-cloud-player-color-play-position" => [
						"title" => "Playback Bar Color",
						"default" => "#FFFFFF",
						"description" => "The color of the playback bar.",
						"type" => "color",
					],
					"media-cloud-player-color-play-position-ball" => [
						"title" => "Playback Bar Ball Color",
						"default" => "#FFFFFF",
						"description" => "The color of the ball at the end of the playback bar.",
						"type" => "color",
					],
					"media-cloud-player-color-load-progress" => [
						"title" => "Load Progress Bar Color",
						"default" => "#545454",
						"description" => "The color of the load progress bar.",
						"type" => "color",
					],
				]
			],
