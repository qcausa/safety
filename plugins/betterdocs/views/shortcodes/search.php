<div class="betterdocs-live-search">
    ...
    <form class="betterdocs-searchform betterdocs-advance-searchform">
        <div class="betterdocs-searchform-input-wrap">
            ...
            <input type="text" class="betterdocs-search-field" name="s" aria-label="<?php echo esc_html__( 'Search Input', 'betterdocs' ) ?>" placeholder="<?php esc_attr_e( $placeholder ) ?>" autocomplete="off" value="<?php esc_attr_e( get_search_query() ) ?>">
