...
class ExtensionsView {
	...
	public static function scripts() {
		...
		Utils::localize_script(
			...
			[
				'error_strings' => [
					'extension_error' => esc_html__( 'Please download it from gplvault.com and install it manually.', 'searchwp' ),
				],
			]
		);
	}
	...
	public static function ajax_install_extension() {
		...
		$error = esc_html__( 'Please download it from gplvault.com and install it manually.', 'searchwp' );
