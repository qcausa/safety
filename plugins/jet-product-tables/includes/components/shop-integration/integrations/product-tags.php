 ...
 */
class Product_Tags extends Product_Taxonomy {
	...
	public function get_name() {
		return __( 'Product Tags', 'jet-wc-product-table' );
	}
	...
	public function get_description() {
		return __( 'Show a table instead of the default products grid on the products tags archives.', 'jet-wc-product-table' );
	}
