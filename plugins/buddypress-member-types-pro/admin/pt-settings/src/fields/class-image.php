...
class Image extends Field {
	...
	public function render( $args ) {
		...
		printf( '<input type="button" class="button pt-settings-upload-image-button" id="%1$s_button" value="%2$s" data-id="%1$s" data-btn-title="%3$s" data-uploader-title="%3$s" />', esc_attr( $id ), __( 'Browse', 'pt-settings' ), __( 'Select', 'pt-settings' ) );
