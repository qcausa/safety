...
/**
 * Auto Loader for BPGTC.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the PressThemes\BPGTC\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/buddypress-user-group-map-pro/src/bar/baz/class-qux.php:
 *
 *      new PressThemes\BPGTC\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/buddypress-user-group-map-pro/src/bar/baz-xyz/class-qux.php
 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
 */
class Autoloader {

	/**
	 * Namespace root. eg. PressThemes\\BPGTC\\(escaped slashes);
	 *
	 * @var string
	 */
